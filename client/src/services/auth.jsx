...
const logout = () => {
  // אם תוסיפי גם logout מהשרת, אפשר להוסיף פה קריאה ל־api.post("/users/logout")
  // אין צורך להסיר localStorage – כי כבר לא שומרים בו כלום
};

const getCurrentUser = () => {
  // לא רלוונטי יותר – תשתמשי במשתמש מה־context
  return null;
};
